...
Также доступен скрипт для тестирования поисковой системы с подготовленными вопросами:
...
### Тестирование токена HuggingFace

Для проверки правильности настройки токена HuggingFace можно использовать тестовый скрипт:
...
Проект включает инструменты для оценки различных моделей эмбеддингов для определения наиболее подходящей для вашей задачи.

### Запуск оценки

Подробная информация о том, как запустить оценку моделей эмбеддингов, находится в файле [scripts/README_evaluation.md](scripts/README_evaluation.md).

```bash
# Запуск оценки моделей эмбеддингов
